...
```{r echo=TRUE, eval=TRUE, result=TRUE}
## Display the 20 last rows of the feature table
...
Selection d'une cellule par indices de ligne et colonne.
...
if (!file.exists(chrom.size.file)) {
    download.file(annot.url, destfile = file.path(dir.tuto, "chrom_sizes.tsv"))
}
