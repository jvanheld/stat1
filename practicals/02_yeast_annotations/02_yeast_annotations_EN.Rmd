...
Your report must be synthetic (1 text page max + many figures and table as you want)
Le rapport doit être synthétique (1 page de texte maximum + autant de figures et tables que vous le désirez). 

Each question have to be explicitly presented before to show results and give interpretation to these restults.
