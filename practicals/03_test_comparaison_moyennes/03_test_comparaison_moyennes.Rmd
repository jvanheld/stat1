...
Au moyen de la fonction R `rnorm()`, tirez deux échantillons de taille $n = 10$ dans des populations normales de moyenne $\mu1 = \mu2 = 7$ et d'écart-type $\sigma1 = \sigma2 = 2$.
