...
boxplot(x = kmer.table[,order(col.stats$median)], horizontal = TRUE, las = 1, col = "#44DDFF", main = "Dinucleotide distributions", xlab = "Counts")
```
...
boxplot(x = kmer.table[,order(col.stats$var)], horizontal = TRUE, las = 1, col = "#44DDFF", main = "Dinucleotide distributions", xlab = "Counts")
```
...
vioplot(kmer.table[, order(col.stats$mean)], horizontal = TRUE, col = "#44DDFF", las = 1, main = "Violin plot of dinucleotide counts in promoters", xlab = "Counts", )
...
vioplot(kmer.table[, order(col.stats$var)], horizontal = TRUE, col = "#44DDFF", las = 1, main = "Violin plot of dinucleotide counts in promoters", xlab = "Counts", )
...
```{r}
plot(col.stats$mean, col.stats$var,
