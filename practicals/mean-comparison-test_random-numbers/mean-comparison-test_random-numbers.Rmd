...
d00 <- iterate.t.test(mu1 = 0, mu2 = 0)  ## Iterations
...
d01 <- iterate.t.test(mu1 = -0.5, mu2 = 0.5)  ## Iterations
d10 <- iterate.t.test(mu1 = -5, mu2 = 5)  ## Iterations
...
pvalHistogram(d00, main = "under H0 (mu1 = mu2)", col = "#BBFFDD")
pvalHistogram(d0.1, main = "mu1 - mu2 = 0.1", col = "#FFDDBB")
pvalHistogram(d0.2, main = "mu1 - mu2 = 0.2", col = "#FFBBAA")
pvalHistogram(d0.5, main = "mu1 - mu2 = 0.5", col = "#FF8866")
pvalHistogram(d01, main = "mu1 - mu2 = 1", col = "#FF6633")
pvalHistogram(d10, main = "mu1 - mu2 = 1", col = "#FF4422")
