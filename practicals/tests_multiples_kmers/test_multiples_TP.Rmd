...
- Le programme a également calculé la probabilité a priori de chaque octanucléotide sur base d'un modèle de Markov d'ordre 5. Autrement dit, la probabilité a priori d'un octanucléotide ($p$) est estimée sur bases des probabilités d'hexanucléotides observées dans l'ensemble des séquences. 
