...
knitr::opts_chunk$set(
  ...
  fig.height = 5, 
  fig.align = "center", 
  fig.path = "figures/multiple_tests_practical_",
  size = "tiny", 
  warning = FALSE, 
  results = TRUE, 
  message = FALSE, 
...
plot(kmer.table$exp.occ, kmer.table$ratio, col = "darkgray",
...
plot(kmer.table$exp.occ, kmer.table$log.ratio, col = "darkgray",
     xlab = "expected occurrences",
     ylab = "log2(exp/occ ratio)"
     )
grid(lty = "solid")
abline(h = 0)
