...
La probabilité jointe d'événements complémentaires vaut 1.
...
Deux événements sont stochastiquement indépendants si al réalisation de l'un n'affecte pas la probabilité de réalisation de l'autre. 
