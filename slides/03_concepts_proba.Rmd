...
```{r echo=FALSE, fig.height=3, out.width="80%", fig.cap="Fréquences de A lors du tirage (avec remise) de positions aléatoires dans le génome de *Mycoplasma genitalium*. "}
################################################################
