...
- On oppose deux hypothèses : l'***hypothèse nulle*** ($H_0$), selon laquelle il n'existe pas de différence entre les deux populations, et l'***hypothèse alternative*** ($H_1$), selon laquelle il existe une différence. 
- On évalue la probabilité qu'un échantillonnage aléatoire sous hypothèse nulle produise une entre moyennes d'échantillons au moins aussi grande que celle qu'on observe (valeur $P$). 
- Si cette probabilité est très faible, on rejette l'hypothèse nulle ($RH_0$). 
